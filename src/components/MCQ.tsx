...
//   if (hasEnded) {
//     return (
//       <div className="pt-4 min-h-screen flex items-center justify-center px-4">
...
//   return (
//     <div className="pt-16 min-h-screen px-4 flex flex-col items-center">
...
//               ${isChecking ? "bg-[#ff7f01]/70 cursor-not-allowed" : "bg-[#ff7f01] hover:bg-[#e67200]"}
