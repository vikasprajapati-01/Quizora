    ...
    <div className="md:col-span-3 bg-[#171717] shadow-lg rounded-lg p-6 border border-gray-800">
      ...
      <div className="flex flex-row items-center justify-center h-40 bg-[#0a0a0a] rounded-lg border border-gray-700 p-4">
        {accuracy > 75 ? (
          ...
          <div className="flex flex-row items-center">
            <FaTrophy className="mr-4 text-gray-400 w-12 h-12" />
            <div className="flex flex-col">
              <span className="text-2xl font-semibold text-gray-400">Good job!</span>
          ...
          <div className="flex flex-row items-center">
            <FaTrophy className="mr-4 text-amber-800 w-12 h-12" />
            <div className="flex flex-col">
              <span className="text-2xl font-semibold text-amber-800">Nice try!</span>
              <span className="text-sm text-gray-500">
                {"< 25% accuracy"}
              </span>
            </div>
